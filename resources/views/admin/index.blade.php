                        ...
                        <div class="card-header border-0 pb-0 flex-wrap">
                            ...
                            <div class="mt-3 mt-sm-0">
                                <ul class="nav nav-tabs vacany-tabs style-1" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link " data-bs-toggle="tab" data-series="Daily" href="index.html#Daily" role="tab">Daily</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link " data-bs-toggle="tab" data-series="Weekly" href="index.html#Weekly" role="tab" >Weekly</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" data-series="Monthly" href="index.html#Monthly" role="tab" >Monthly</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="card" id="user-activity1">
                        <div class="card-header border-0 pb-0">
                            ...
                            <ul class="nav nav-tabs style-1 chart-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link " data-bs-toggle="tab" data-series="Daily" href="index.html#Daily1" role="tab">Daily</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " data-bs-toggle="tab" data-series="Weekly" href="index.html#Weekly1" role="tab" >Weekly</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" data-series="Monthly" href="index.html#Monthly1" role="tab" >Monthly</a>
                                </li>
                            </ul>
                        </div>
