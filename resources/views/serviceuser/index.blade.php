                        ...
                        <div class="owl-carousel jobs-owl owl-theme">
                                ...
                                <div class="job-item">
                                    <div class="job-top-dt">
                                        <div class="job-left-dt">
                                            <img src="{{asset('frontend/images/homepage/latest-jobs/img-1.jpg')}}" alt="">
                                            <div class="job-ut-dts">
                                                <a href="index.html#"><h4>John Doe</h4></a>
                                    ...
                                    <div class="job-buttons">
                                        <ul class="link-btn">
                                            <li><a href="index.html#" class="link-j1" title="Apply Now">APPLY NOW</a></li>
                            ...
                            <div class="item">
                                <div class="job-item">
                                    <div class="job-top-dt">
                                        <div class="job-left-dt">
                                            <img src="{{asset('frontend/images/homepage/latest-jobs/img-2.jpg')}}" alt="">
                                            <div class="job-ut-dts">
                                                <a href="index.html#"><h4>Johnson Smith</h4></a>
                            ...
                            <div class="item">
                                <div class="job-item">
                                    <div class="job-top-dt">
                                        <div class="job-left-dt">
                                            <img src="{{asset('frontend/images/homepage/latest-jobs/img-3.jpg')}}" alt="">
                                            <div class="job-ut-dts">
                                                <a href="index.html#"><h4>Envato</h4></a>
                            ...
                            <div class="item">
                                <div class="job-item">
                                    <div class="job-top-dt">
                                        <div class="job-left-dt">
                                            <img src="{{asset('frontend/images/homepage/latest-jobs/img-4.jpg')}}" alt="">
                                            <div class="job-ut-dts">
                                                <a href="index.html#"><h4>Joy Smith</h4></a>
                                                <span><i class="fas fa-map-marker-alt"></i> India</span>
                                            </div>
                                        </div>
                                        <div class="job-right-dt">
                            ...
                            <div class="item">
                                <div class="job-item">
                                    <div class="job-top-dt">
                                        <div class="job-left-dt">
                                            <img src="{{asset('frontend/images/homepage/latest-jobs/img-5.jpg')}}" alt="">
                                            <div class="job-ut-dts">
                                                <a href="index.html#"><h4>Jassica William</h4></a>
                                                <span><i class="fas fa-map-marker-alt"></i> Australia</span>
                                            </div>
                                        </div>
                                        <div class="job-right-dt">
                            ...
                            <div class="item">
                                <div class="job-item">
                                    <div class="job-top-dt">
                                        <div class="job-left-dt">
                                            <img src="{{asset('frontend/images/homepage/latest-jobs/img-6.jpg')}}" alt="">
                                            <div class="job-ut-dts">
                                                <a href="index.html#"><h4>Gambolthemes</h4></a>
                                                <span><i class="fas fa-map-marker-alt"></i> India</span>
                                            </div>
                                        </div>
                                        <div class="job-right-dt">
                    ...
                    <div class="job-categories mt-30">
                        <div class="row no-gutters">
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-5.svg')}}" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-2.svg')}}" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-3.svg')}}" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-4.svg')}}" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-11.svg')}}" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-13.svg')}}" alt="">
                                        <span>Writing</span>
                                        <p>90 Jobs</p>
                                    </a>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-14.svg')}}" alt="">
                                        <span>Legal</span>
                                        <p>250 Jobs</p>
                                    </a>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-15.svg')}}" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-9.svg')}}" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-16.svg')}}" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-17.svg')}}" alt="">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="p-category">
                                    <a href="index.html#" title="">
                                        <img src="{{asset('frontend/images/homepage/categories/icon-7.svg')}}" alt="">
                        ...
                        <div class="owl-carousel jobs-owl owl-theme">
                                ...
                                <div class="job-item">
                                    ...
                                    <div class="job-buttons">
                                        <ul class="link-btn">
                                            ...
                                            <li><a href="index.html#" class="link-j1" title="Hire Me">Hire Me</a></li>
                                            <li class="bkd-pm"><button class="bookmark1" title="bookmark"><i class="fas fa-heart"></i></button></li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="job-item">
                                    <div class="job-top-dt1 text-center">
                                        <div class="job-center-dt">
                                            <img src="{{asset('frontend/images/homepage/candidates/img-2.jpg')}}" alt="">
                                            <div class="job-urs-dts">
                                                <a href="index.html#"><h4>Albert Dua</h4></a>
                            ...
                            <div class="item">
                                <div class="job-item">
                                    <div class="job-top-dt1 text-center">
                                        <div class="job-center-dt">
                                            <img src="{{asset('frontend/images/homepage/candidates/img-3.jpg')}}" alt="">
                                            <div class="job-urs-dts">
                                                <a href="index.html#"><h4>Rock William</h4></a>
                            ...
                            <div class="item">
                                <div class="job-item">
                                    <div class="job-top-dt1 text-center">
                                        <div class="job-center-dt">
                                            <img src="{{asset('frontend/images/homepage/candidates/img-4.jpg')}}" alt="">
                                            <div class="job-urs-dts">
                                                <a href="index.html#"><h4>Joy Smith</h4></a>
                            ...
                            <div class="item">
                                <div class="job-item">
                                    <div class="job-top-dt1 text-center">
                                        <div class="job-center-dt">
                                            <img src="{{asset('frontend/images/homepage/candidates/img-5.jpg')}}" alt="">
                                            <div class="job-urs-dts">
                                                <a href="index.html#"><h4>Sanaya Sharma</h4></a>
                            ...
                            <div class="item">
                                <div class="job-item">
                                    <div class="job-top-dt1 text-center">
                                        <div class="job-center-dt">
                                            <img src="{{asset('frontend/images/homepage/candidates/img-6.jpg')}}" alt="">
                                            <div class="job-urs-dts">
                                                <a href="index.html#"><h4>Jass Singh</h4></a>
