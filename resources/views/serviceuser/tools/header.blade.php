                                ...
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-menu message-dropdown dropdown-menu-right">
                                        ...
                                        <div class="user-request-list">
                                            <div class="request-users">
                                                <div class="user-request-dt">
                                                    <a href="{{ route('view.serviceuser.home')}}""><img src="{{asset('frontend/images/user-dp-1.jpg')}}" alt="">
                                ...
                                <li>
                                    <div class="account order-1 dropdown">
                                        <a href="" class="account-link dropdown-toggle-no-caret" role="button" data-toggle="dropdown">
                                            <div class="user-dp"><img src="{{asset('frontend/images/dp.jpg')}}" alt=""></div>
                                            <span>Hi! John</span>
                                        ...
                                        <div class="dropdown-menu account-dropdown dropdown-menu-right">
                                            ...
                                            <a class="link-item" href="{{ route('view.suorder.list')}}">Order List</a>
                                            <a class="link-item" href="{{ route('view.sumessages')}}">My Messages</a>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <nav class="navbar navbar-expand-lg navbar-light bg-dark1 justify-content-sm-start">
                        <a class="order-1 order-lg-0 ml-lg-0 ml-3 mr-auto" href=""><img src="{{asset('frontend/images/logo.svg')}}" alt=""></a>
                        ...
                        <div class="collapse navbar-collapse d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-end bg-dark1 p-3 p-lg-0 mt1-5 mt-lg-0 mobileMenu" id="navbarSupportedContent">
                            <ul class="navbar-nav align-self-stretch">
                                <li class="nav-item {{ request()->routeIs('view.home') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('view.serviceuser.home')}}">Home <span class="sr-only">(current)</span></a>
                                </li>
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{route('view.serviceuser.about')}}">About <span class="sr-only"></span></a>
                                </li>
                            </ul>
                            <a href="" class="add-post">Post a Job</a>
                        </div>
