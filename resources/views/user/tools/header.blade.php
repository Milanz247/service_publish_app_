                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="lang-icon dropdown">
                                        ...
                                        <a href="about.html#" class="icon15 dropdown-toggle-no-caret" role="button" data-toggle="dropdown">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="account order-1 dropdown">
                                        <a href="about.html#" class="account-link dropdown-toggle-no-caret" role="button" data-toggle="dropdown">
                                            <div class="user-dp"><img src="{{ asset('images/user_profile/' . Auth::user()->image) }}" alt=""></div>
                                            <span>Hi! {{ Auth::user()->fname}}</span>
                                            <i class="fas fa-sort-down"></i>
                                        </a>
                                        <div class="dropdown-menu account-dropdown dropdown-menu-right">
                                            {{-- <a class="link-item" href="{{route('view.user.dashboard')}}">Dashboard</a> --}}
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <nav class="navbar navbar-expand-lg navbar-light bg-dark1 justify-content-sm-start">
                        <a class="order-1 order-lg-0 ml-lg-0 ml-3 mr-auto" href="{{route('view.user.home')}}"><img src="{{asset('frontend/images/logo.svg')}}" alt=""></a>
                        ...
                        <div class="collapse navbar-collapse d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-end bg-dark1 p-3 p-lg-0 mt1-5 mt-lg-0 mobileMenu" id="navbarSupportedContent">
                            <ul class="navbar-nav align-self-stretch">
                                <li class="nav-item ">
                                    <a class="nav-link {{ request()->routeIs('view.user.home') ? 'active' : '' }}" href="{{route('view.user.home')}}">Home <span class="sr-only">(current)</span></a>
                                </li>

                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ route('view.user.service')}}">Services <span class="sr-only"></span></a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="index.html">About <span class="sr-only"></span></a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="index.html">Contact Us <span class="sr-only"></span></a>
                                </li>

                            </ul>
                            <a href="about.html#" class="search-link" role="button" data-toggle="modal" data-target="#searchModal"><i class="fas fa-search"></i></a>
